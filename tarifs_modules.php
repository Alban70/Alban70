<section class="content3">
    <div class="view2" id="cm_vente">
        ...
        <div class="content_vente">
            <div class="imag_vente">
                <img src="http://localhost/wcMVCp1/\uploads\Logo-Well-Com-Couleur.svg" alt="logo">
            </div>
        </div>
    </div>
                            ...
                            <div class="content4" style="background-color: #ffc107">
                                <div class="fonction_tarif">
                                    <a href="HomePageCRMv2.html" class="txt_lien_white"
                                       ;>Contact Manager</a><br>
                                </div>
                                <div class="imag_bandeau">
                                    <img src="http://localhost/wcMVCp1/\images\icon\sign-icon.png" alt="logo">
                                </div>

                                <div class="fonction_tarif">
                                    <input type="hidden" name="cm_id" id="cm_id"
                                           value="16">
                                    <input type="hidden" name="prix_id" id="prix_id" value="20.00">
                                    <span style="color: white">20.00€HT\Mois</span><br>
                                </div>
                                <div class="fonction_tarif">
                                    <a href="HomePageCRMv2.html" class="txt_lien_white"
    ...
    <div class="content_center" style="background-color: #4A89DC">
        <div class="fonct_txt_HP">
            <p class="txt_lien_white">Nombre d'utilisateurs :</p>
        </div>
        </br>
        <div class="form">
        ...
        <div class="content_padding_top_button">
            <button class="btn btn-primary" name="test"
                    style="background-color: #ffc107; !important;">Tester grauitement
                                ...
                                <div class="content4" id="cal">
    <div class="content_center" style="background-color: lightgray">
        <div class="fonction_tarif">
            <p class="txt_lien_white">OPTION</p><br>
        </div>
        <div class="fonction_tarif">
            <a href="HomePageCRMv2.html" class="txt_lien_white"
               ;>Assistance téléphonique illimitée</a><br>
        </div>
        <div class="content_contact">
            <div class="fonct_txt_HP">
                <ul class="ul_center_sm">
                    <li class="txt_fonctionnalite_t" style="color: white">Interlocuteur dédié</li>
                    <li class="txt_fonctionnalite_t" style="color: white">Réponse garantie dans les 4 Heures</li>
                    <li class="txt_fonctionnalite_t">Automatisation des processus</li>
                </ul>
            </div>
        </div>
        <!--<div class="fonct_txt_HP">
            ...
            <button class="btn btn-primary" name="test"
                    style="background-color: #ffc107; !important;">Tester grauitement
                        ...
                        <li class="fonct_tarifs">
                            <div class="content4" style="background-color: #ffc107">
                                <div class="imag_bandeau">
                                    <img src="http://localhost/wcMVCp1/\images\icon\users-icon.png" alt="logo">
                                </div>
                                ...
                                <div class="fonction_tarif">
                                    ...
                                    <span style="color: white">20.00€HT\Mois</span>
                                </div>
                            </div>
