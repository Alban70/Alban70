<section class="topheader">
    ...
    <div class="essai2" style="margin-left: 360px">
        <!--<div class="demo">
        ...
        <nav class="nav_bar">
            <ul style="margin-left: 470px">
                <li class="Fonctionnalite">
                    <a class="mon_nav" href="?page=acceuil">Clients</a>
                </li>
                <li class="Fonctionnalite">
                <a class="mon_nav" href="?page=acceuil">Prospects</a>
                </li>
                <li class="Fonctionnalite">
                    <a class="mon_nav" href="?page=demande">Actions</a>
                </li>
                <li class="Fonctionnalite">
                <a class="mon_nav" href="?page=commande">Commandes</a>
                </li>
                <!--<li class="Fonctionnalite">
                    <a class="mon_nav" href="?page=livraison">Livaison</a>
                </li>
                <li class="Fonctionnalite">
                    <a class="mon_nav" href="?page=facture">Facture</a>
                </li>-->
            </ul>
        </nav>
    </div>
