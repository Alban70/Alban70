<section class="content3">
    <div class="view2" id="cm_vente">
        <div class="content_vente">
            ...
            <div class="content4">
                <p class="txt_slogan">Well-Com solution vous propose son logiciel CRM décliné sous forme de module selon
                    vos besoins fonctionnels, Testez et découvrez librement la richesse notre gamme. N'hésitez pas à
                    contacter notre service client au 04 55 66 88 99. Nos conseillers sauront vous accompagner dans
                    l'éxpressions de vos besoins</p>
            </div>
    ...
    <section class="menu_fonct3">
        ...
        <div class="content_titre_blue">
            ...
            <div class="content4">
                <p class="txt_withe_centre">Choisissez les modules en fonction des besoins pour chacun de vos
                    collaborateurs.</p>
            </div>
        </div>
        <div class="content_footer">
            <form method="post" action="?page=commandeLigne" id="searchForm">
                <ul class="content4">

                    <div class="cta-tarifs" style="background-color: white">
                        <?php
                            ...
                            <li class="fonct_tarifs">
                                <div class="content4" style="background-color: #ffc107">
                                    ...
                                    <div class="fonction_tarif">
                                        <input type="hidden" name="soc_id" id="soc_id"
                                               value="<?php echo $commande['soc_id']; ?>">
                                        <input type="hidden" id="com_id" name="com_id"
                                               value="<?php echo $commande['com_id']; ?>">

                                        <input type="number" name="valeur_id" id="valeur_id">
                                    ...
                                    <div class="content4" id="cal">
                                        <div class="content_center" style="background-color: #4A89DC">
                                            <div class="content_padding_top_button">
                                                <!--<button class="btn btn-primary" id="addComL" name="addComL" style="background-color: #ffc107; !important;" onclick="articleL();">Choisissez ce produit</button>-->
                                                <!--id="addComL"-->
                                                <input type="hidden" name="article_id" id="article_id" value="<?php echo $article['article_id']; ?>" >
                                                <button class="btn btn-primary" name="addComL" style="background-color: #ffc107; !important;">
                                                    Choisissez ce produit
                                                </button>
                                            </div>
                                        </div>
                                    </div>
