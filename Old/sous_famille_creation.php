 ...
 <body>
        <div id="page">
            ...
            <section class="main-view">
                  <div class="categorie">
	               <form method="post" action="creat_sous_famille.php">
         
                    <fieldset>
                   <legend>Sous Famille</legend> <!-- Titre du fieldset --> 

                        <label for="sousfamille">S/Famille</label>
                        <input type="text" name="sousfamille" id="sousfamille">
