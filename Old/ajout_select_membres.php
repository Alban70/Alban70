...
{
$ajou_ms=$bdd->prepare('INSERT INTO membre_selection (ms_idm, ms_idmcl) VALUES (:ms_idm, :ms_idmcl)');
$ajou_ms->execute(array(
    'ms_idm' => $_POST['valeur_id'],
    'ms_idmcl' => $_SESSION['id'],    
    
));
echo "le consultant n° " .$_SESSION['valeur_id']. " a été ajouté";
echo "le client n° " .$_SESSION['id']. " a été ajouté";
}
else        
{
