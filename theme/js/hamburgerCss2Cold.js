    ...
    if(ID_fonctNav5) {
        if (dHamburger5) {
            dHamburger5.addEventListener("click", function () {
                dHamburger5.classList.remove("container");
                dHamburger5.classList.add("containerCacher");
                dCross5.classList.remove("changeCacher");
                dCross5.classList.add("change");

                hamburger5.classList.remove("txt");
                hamburger5.classList.add("txtCacher");
                cross5.classList.add("menu_fonct_HPright");
                cross5.classList.remove("menu_fonct_HPrightCacher");
            });
        }
        ;
        ...
        if (dCross5) {
            dCross5.addEventListener("click", function () {
                dCross5.classList.remove("change");
                dCross5.classList.add("changeCacher");
                dHamburger5.classList.remove("containerCacher");
                dHamburger5.classList.add("container");


                hamburger5.classList.remove("txtCacher");
                hamburger5.classList.add("txt");
                cross5.classList.add("menu_fonct_HPrightCacher");
                cross5.classList.remove("menu_fonct_HPright");
            });
        };
    ...
    if(ID_fonctNav4) {
        if (dHamburger4) {
            dHamburger4.addEventListener("click", function () {
                ...
                cross4.classList.remove("menu_fonct_HPCacher");
        ...
        if (dCross4) {
            dCross4.addEventListener("click", function () {
                ...
                cross4.classList.add("menu_fonct_HPCacher");
