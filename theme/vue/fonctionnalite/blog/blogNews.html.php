...
?>
<nav>
    <?php for($p=1; $p <= $nbPage; $p++):  ?>
<!--<a href="?page=catalogue&action=detail&id=<?php //echo $id; ?>$p=<?php //echo $p; ?> "><?php //echo $p; ?></a>-->
        <a href="?page=blog&action=index&$p=<?php echo $p; ?> "><?php echo $p; ?></a>
    <?php endfor; ?>
</nav>
