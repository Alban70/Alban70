<section class="content4">
    ...
    <section class="content_contact">
        <form method="post" action="<?php echo \Lib\Application::$racine ?>theme_membresPo/web/connexion/register">
            ...
            <br>
            <a class="register-link" href="<?php echo \Lib\Application::$racine ?>theme_membresPo/web/connexion/register">Pas encore inscrit ? Inscrivez-vous</a>
        </form>

    </section>


        <!--<form method="post" id="formulaire" name="formulaire" action="<?php //echo \Lib\Application::$racine ?>theme_adminPo/web/connexion/register">
            <p>bonjour</p>
