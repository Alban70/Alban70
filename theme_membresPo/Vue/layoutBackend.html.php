...
<head>
    ...
    <link rel="stylesheet" href="<?php echo \lib\Application::$racine; ?>/theme/css/uitotop.css">
    <!--<link rel="stylesheet" media="screen" href="<?php //echo \lib\Application::$racine; ?>theme_admin/css/style.css" type="text/css">-->


    <link rel="stylesheet" href="<?php echo \lib\Application::$racine; ?>theme/css/style.css" >
    <style>
        .firstLink{
            color: #000000;
        }
