        ...
        <nav class="nav_bar">
            <ul>
                ...
                <li class="Fonctionnalite">
                    <a class="mon_nav" href="<?php echo \lib\Application::$racine; ?>theme_membresPo/web/membre">Membre</a>
                </li>
                </li>
                <li class="Fonctionnalite">
                    <a class="mon_nav" href="<?php echo \lib\Application::$racine; ?>theme_membresPo/web/commande">Commande</a>
                </li>
                <li class="Fonctionnalite">
                    <a class="mon_nav" href="<?php echo \lib\Application::$racine; ?>theme_membresPo/web/connexion/disconnect">Déconnexion</a>
                </li>
            </ul>
        </nav>
    </div>
