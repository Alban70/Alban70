...
<form method="post" action="?page=commandeAction">
    ...
    <fieldset>
        ...
        <input type="number" id="id2" name="id2" value= "76" >

            <label for="libelle">libelle</label>
            <input type="text"  name="libelle" id="libelle" value= "null">
...
<table id="tableau" class="table table-sm table-dark table-hover" weight="400px">
    ...
    <tr id='id1'><td id='id1'>93</td><td >formation</td><td ></td><td ></td><td ></td><td><input type='checkbox' id='suppr1' onclick='numeroL();' /></td></tr>
</table>
